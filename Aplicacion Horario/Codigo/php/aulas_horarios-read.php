...
if(isset($_GET["ID_aulas_horarios"]) && !empty($_GET["ID_aulas_horarios"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_GET["ID_aulas_horarios"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>Aula</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["AULAS_DISPONIBLES_ID_aula_disponible"]); ?></p>
                        </div><div class="form-group">
                            <h4>Estado</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["estado"]); ?></p>
                        </div><div class="form-group">
                            <h4>Día</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["dia"]); ?></p>
                        </div>

                    <p><a href="aulas_horarios-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
