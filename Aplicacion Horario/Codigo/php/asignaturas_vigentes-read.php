...
if(isset($_GET["ID_asignatura_vigente"]) && !empty($_GET["ID_asignatura_vigente"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_GET["ID_asignatura_vigente"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>Asignatura</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["ASIGNATURAS_ID_asignatura"]); ?></p>
                        </div>

                    <p><a href="asignaturas_vigentes-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
