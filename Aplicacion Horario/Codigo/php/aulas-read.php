                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>Bloque</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["bloque"]); ?></p>
                        </div><div class="form-group">
                            <h4>Piso</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["piso"]); ?></p>
                        </div>

                    <p><a href="aulas-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
