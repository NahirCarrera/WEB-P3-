            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Agregar Perfiles Details</h2>
                        <a href="perfiles-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="perfiles-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=tipo&sort=$sort>Tipo</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['tipo']) . "</td>";echo "<td>" . htmlspecialchars($row['permisos']) . "</td>";
                                        echo "<td>";
                                            echo "<a href='perfiles-read.php?ID_perfil=". $row['ID_perfil'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='perfiles-update.php?ID_perfil=". $row['ID_perfil'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='perfiles-delete.php?ID_perfil=". $row['ID_perfil'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
