...
if(isset($_GET["ID_horario_disponible"]) && !empty($_GET["ID_horario_disponible"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_GET["ID_horario_disponible"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            <h4>Horario</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["HORARIOS_ID_horario"]); ?></p>
                        </div><div class="form-group">
                            <h4>Periodo</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["PERIODOS_ID_periodo"]); ?></p>
                        </div>

                    <p><a href="horarios_disponibles-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
