...
if(isset($_GET["ID_aula_disponible"]) && !empty($_GET["ID_aula_disponible"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_GET["ID_aula_disponible"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            <h4>Aula</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["AULAS_ID_aula"]); ?></p>
                        </div><div class="form-group">
                            <h4>Periodo</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["PERIODOS_ID_periodo"]); ?></p>
                        </div><div class="form-group">
                            <h4>Capacidad</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["capacidad"]); ?></p>
                        </div>

                    <p><a href="aulas_disponibles-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
