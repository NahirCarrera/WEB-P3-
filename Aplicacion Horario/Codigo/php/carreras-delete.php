...
if(isset($_POST["ID_carrera"]) && !empty($_POST["ID_carrera"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_POST["ID_carrera"]);
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="ID_carrera" value="<?php echo trim($_GET["ID_carrera"]); ?>"/>
                            <p>Are you sure you want to delete this record?</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="carreras-index.php" class="btn btn-secondary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
