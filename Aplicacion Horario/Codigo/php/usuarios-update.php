...
if(isset($_POST["ID_usuario"]) && !empty($_POST["ID_usuario"])){
    ...
    $stmt = $pdo->prepare("UPDATE usuarios SET nombre=?,contraseña=?,PERFILES_ID_perfil=?  WHERE ID_usuario=?");

    if(!$stmt->execute([ $nombre,$contraseña,$PERFILES_ID_perfil,$ID_usuario  ])) {
