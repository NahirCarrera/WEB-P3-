            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Agregar Horarios Details</h2>
                        <a href="horarios-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="horarios-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                    ...
                    $orderBy = array('hora_inicio', 'hora_fin');
                    $order = 'ID_horario';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM horarios
                            WHERE CONCAT_WS (hora_inicio,hora_fin)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['hora_inicio']) . "</td>";echo "<td>" . htmlspecialchars($row['hora_fin']) . "</td>";
                                        echo "<td>";
                                            echo "<a href='horarios-read.php?ID_horario=". $row['ID_horario'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='horarios-update.php?ID_horario=". $row['ID_horario'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='horarios-delete.php?ID_horario=". $row['ID_horario'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
