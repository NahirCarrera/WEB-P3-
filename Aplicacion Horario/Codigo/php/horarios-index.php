            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Franjas Horarias</h2>
                        <a href="horarios-create.php" class="btn btn-success float-right">Agregar</a>
                        <a href="horarios-index.php" class="btn btn-info float-right mr-2">Refrescar</a>
