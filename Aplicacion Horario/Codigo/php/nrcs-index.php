            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Agregar Cursos Details</h2>
                        <a href="nrcs-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="nrcs-index.php" class="btn btn-info float-right mr-2">Reset View</a>
