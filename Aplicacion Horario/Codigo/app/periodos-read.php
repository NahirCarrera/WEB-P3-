                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <p class="form-control-static"><?php echo htmlspecialchars($row["fecha_inicio"]); ?></p>
                        </div><div class="form-group">
                            <h4>Fecha de finalización</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["fecha_fin"]); ?></p>
                        </div>

                    <p><a href="periodos-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
