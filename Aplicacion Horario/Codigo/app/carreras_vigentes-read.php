...
if(isset($_GET["ID_carrera_vigente"]) && !empty($_GET["ID_carrera_vigente"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_GET["ID_carrera_vigente"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>Carrera</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["CARRERAS_ID_carrera"]); ?></p>
                        </div>

                    <p><a href="carreras_vigentes-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
