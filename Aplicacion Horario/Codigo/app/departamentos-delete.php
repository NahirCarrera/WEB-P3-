...
if(isset($_POST["ID_departamento"]) && !empty($_POST["ID_departamento"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_POST["ID_departamento"]);
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="ID_departamento" value="<?php echo trim($_GET["ID_departamento"]); ?>"/>
                            <p>Are you sure you want to delete this record?</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="departamentos-index.php" class="btn btn-secondary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
