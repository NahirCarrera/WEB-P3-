...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO asignaturas_vigentes (PERIODOS_ID_periodo,ASIGNATURAS_ID_asignatura) VALUES (?,?)");

        if($stmt->execute([ $PERIODOS_ID_periodo,$ASIGNATURAS_ID_asignatura  ])) {
                $stmt = null;
